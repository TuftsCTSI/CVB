...
source_concept_id,
    ...
    final_decision,
    final_comment)
SELECT NULL AS source_concept_id,
       TRIM(LEFT (source_concept_code, 50)),
    ...
    orcid_id,
    author_comment,
    status, site_name, change_required, final_decision, final_comment
FROM all_mappings
WHERE NULLIF (TRIM (LEFT (source_concept_code
    , 50))
    , '') IS NOT NULL
  AND TRIM (decision) = '1';
