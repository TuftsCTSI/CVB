...
CREATE TABLE temp.domain_delta AS (SELECT * FROM vocab.domain WHERE (relationship_concept_id > 2051500000 AND relationship_concept_id < 2052500000) ORDER BY relationship_concept_id);
