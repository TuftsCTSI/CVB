...
async function commitFiles() {
  ...
  var local_files   = [
                      '/tmp/runner/CVB/CVB/GIS/Ontology/concept_ancestor_delta.csv',
                      '/tmp/runner/CVB/CVB/GIS/Ontology/concept_class_delta.csv',
                      '/tmp/runner/CVB/CVB/GIS/Ontology/concept_delta.csv',
                      '/tmp/runner/CVB/CVB/GIS/Ontology/concept_relationship_delta.csv',
                      '/tmp/runner/CVB/CVB/GIS/Ontology/concept_synonym_delta.csv',
                      '/tmp/runner/CVB/CVB/GIS/Ontology/domain_delta.csv',
                      '/tmp/runner/CVB/CVB/GIS/Ontology/mapping_metadata.csv',
                      '/tmp/runner/CVB/CVB/GIS/Ontology/relationship_delta.csv',
                      '/tmp/runner/CVB/CVB/GIS/Ontology/restore.sql',
                      '/tmp/runner/CVB/CVB/GIS/Ontology/source_to_concept_map.csv',
                      '/tmp/runner/CVB/CVB/GIS/Ontology/update_log.csv',
                      '/tmp/runner/CVB/CVB/GIS/Ontology/vocabulary_delta.csv'
  ];

  var gh_file_list  = [
                      'https://api.github.com/repos/TuftsCTSI/CVB/contents/GIS/Ontology/concept_ancestor_delta.csv',
                      'https://api.github.com/repos/TuftsCTSI/CVB/contents/GIS/Ontology/concept_class_delta.csv',
                      'https://api.github.com/repos/TuftsCTSI/CVB/contents/GIS/Ontology/concept_delta.csv',
                      'https://api.github.com/repos/TuftsCTSI/CVB/contents/GIS/Ontology/concept_relationship_delta.csv',
                      'https://api.github.com/repos/TuftsCTSI/CVB/contents/GIS/Ontology/concept_synonym_delta.csv',
                      'https://api.github.com/repos/TuftsCTSI/CVB/contents/GIS/Ontology/domain_delta.csv',
                      'https://api.github.com/repos/TuftsCTSI/CVB/contents/GIS/Ontology/mapping_metadata.csv',
                      'https://api.github.com/repos/TuftsCTSI/CVB/contents/GIS/Ontology/relationship_delta.csv',
                      'https://api.github.com/repos/TuftsCTSI/CVB/contents/GIS/Ontology/restore.sql',
                      'https://api.github.com/repos/TuftsCTSI/CVB/contents/GIS/Ontology/source_to_concept_map.csv',
                      'https://api.github.com/repos/TuftsCTSI/CVB/contents/GIS/Ontology/update_log.csv',
                      'https://api.github.com/repos/TuftsCTSI/CVB/contents/GIS/Ontology/vocabulary_delta.csv'
  ];
