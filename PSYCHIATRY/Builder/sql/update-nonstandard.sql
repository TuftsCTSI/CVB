...
INSERT INTO vocab.concept_ns_staging (concept_id,
                                      ...
                                      synonym,
                                      predicate_id)
SELECT row_number() OVER (ORDER BY source_concept_code) + (SELECT COALESCE(max(concept_id),2071500000) FROM vocab.concept WHERE concept_id < 2072000000 AND concept_id > 2071500000) AS concept_id,
