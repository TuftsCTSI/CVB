...
function updateGHFile() {
  ...
  var url_list      = [
                      'https://docs.google.com/spreadsheets/d/1hWFDQ620buxGAZPXDPRHXbs-tz5m3zqEGWBgyCEPYtM/export?format=csv&#gid=0',
  ];

  var gh_file_list  = [
                      'https://api.github.com/repos/TuftsCTSI/CVB/contents/PSYCHIATRY/Mappings/psych_mapping.csv',
