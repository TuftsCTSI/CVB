...
async function commitFiles() {
  ...
  var local_files   = [
                      '/tmp/runner/CVB/CVB/WAVEFORM/Ontology/concept_ancestor_delta.csv',
                      '/tmp/runner/CVB/CVB/WAVEFORM/Ontology/concept_class_delta.csv',
                      '/tmp/runner/CVB/CVB/WAVEFORM/Ontology/concept_delta.csv',
                      '/tmp/runner/CVB/CVB/WAVEFORM/Ontology/concept_relationship_delta.csv',
                      '/tmp/runner/CVB/CVB/WAVEFORM/Ontology/concept_synonym_delta.csv',
                      '/tmp/runner/CVB/CVB/WAVEFORM/Ontology/domain_delta.csv',
                      '/tmp/runner/CVB/CVB/WAVEFORM/Ontology/mapping_metadata.csv',
                      '/tmp/runner/CVB/CVB/WAVEFORM/Ontology/relationship_delta.csv',
                      '/tmp/runner/CVB/CVB/WAVEFORM/Ontology/restore.sql',
                      '/tmp/runner/CVB/CVB/WAVEFORM/Ontology/source_to_concept_map.csv',
                      '/tmp/runner/CVB/CVB/WAVEFORM/Ontology/update_log.csv',
                      '/tmp/runner/CVB/CVB/WAVEFORM/Ontology/vocabulary_delta.csv'
  ];

  var gh_file_list  = [
                      'https://api.github.com/repos/TuftsCTSI/CVB/contents/WAVEFORM/Ontology/concept_ancestor_delta.csv',
                      'https://api.github.com/repos/TuftsCTSI/CVB/contents/WAVEFORM/Ontology/concept_class_delta.csv',
                      'https://api.github.com/repos/TuftsCTSI/CVB/contents/WAVEFORM/Ontology/concept_delta.csv',
                      'https://api.github.com/repos/TuftsCTSI/CVB/contents/WAVEFORM/Ontology/concept_relationship_delta.csv',
                      'https://api.github.com/repos/TuftsCTSI/CVB/contents/WAVEFORM/Ontology/concept_synonym_delta.csv',
                      'https://api.github.com/repos/TuftsCTSI/CVB/contents/WAVEFORM/Ontology/domain_delta.csv',
                      'https://api.github.com/repos/TuftsCTSI/CVB/contents/WAVEFORM/Ontology/mapping_metadata.csv',
                      'https://api.github.com/repos/TuftsCTSI/CVB/contents/WAVEFORM/Ontology/relationship_delta.csv',
                      'https://api.github.com/repos/TuftsCTSI/CVB/contents/WAVEFORM/Ontology/restore.sql',
                      'https://api.github.com/repos/TuftsCTSI/CVB/contents/WAVEFORM/Ontology/source_to_concept_map.csv',
                      'https://api.github.com/repos/TuftsCTSI/CVB/contents/WAVEFORM/Ontology/update_log.csv',
                      'https://api.github.com/repos/TuftsCTSI/CVB/contents/WAVEFORM/Ontology/vocabulary_delta.csv'
  ];
