...
async function commitFiles() {
  ...
  var local_files   = [
                      '/tmp/runner/CVB/CVB/MIMIC/Ontology/concept_ancestor_delta.csv',
                      '/tmp/runner/CVB/CVB/MIMIC/Ontology/concept_class_delta.csv',
                      '/tmp/runner/CVB/CVB/MIMIC/Ontology/concept_delta.csv',
                      '/tmp/runner/CVB/CVB/MIMIC/Ontology/concept_relationship_delta.csv',
                      '/tmp/runner/CVB/CVB/MIMIC/Ontology/concept_synonym_delta.csv',
                      '/tmp/runner/CVB/CVB/MIMIC/Ontology/domain_delta.csv',
                      '/tmp/runner/CVB/CVB/MIMIC/Ontology/mapping_metadata.csv',
                      '/tmp/runner/CVB/CVB/MIMIC/Ontology/relationship_delta.csv',
                      '/tmp/runner/CVB/CVB/MIMIC/Ontology/restore.sql',
                      '/tmp/runner/CVB/CVB/MIMIC/Ontology/source_to_concept_map.csv',
                      '/tmp/runner/CVB/CVB/MIMIC/Ontology/update_log.csv',
                      '/tmp/runner/CVB/CVB/MIMIC/Ontology/vocabulary_delta.csv'
  ];

  var gh_file_list  = [
                      'https://api.github.com/repos/TuftsCTSI/CVB/contents/MIMIC/Ontology/concept_ancestor_delta.csv',
                      'https://api.github.com/repos/TuftsCTSI/CVB/contents/MIMIC/Ontology/concept_class_delta.csv',
                      'https://api.github.com/repos/TuftsCTSI/CVB/contents/MIMIC/Ontology/concept_delta.csv',
                      'https://api.github.com/repos/TuftsCTSI/CVB/contents/MIMIC/Ontology/concept_relationship_delta.csv',
                      'https://api.github.com/repos/TuftsCTSI/CVB/contents/MIMIC/Ontology/concept_synonym_delta.csv',
                      'https://api.github.com/repos/TuftsCTSI/CVB/contents/MIMIC/Ontology/domain_delta.csv',
                      'https://api.github.com/repos/TuftsCTSI/CVB/contents/MIMIC/Ontology/mapping_metadata.csv',
                      'https://api.github.com/repos/TuftsCTSI/CVB/contents/MIMIC/Ontology/relationship_delta.csv',
                      'https://api.github.com/repos/TuftsCTSI/CVB/contents/MIMIC/Ontology/restore.sql',
                      'https://api.github.com/repos/TuftsCTSI/CVB/contents/MIMIC/Ontology/source_to_concept_map.csv',
                      'https://api.github.com/repos/TuftsCTSI/CVB/contents/MIMIC/Ontology/update_log.csv',
                      'https://api.github.com/repos/TuftsCTSI/CVB/contents/MIMIC/Ontology/vocabulary_delta.csv'
  ];
