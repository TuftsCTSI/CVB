...
function updateGHFile() {
  ...
  var url_list      = [
                      'https://docs.google.com/spreadsheets/d/1lto2OlLgSVMbb5lVPH0a3TSo7XmA9JMmWE5LjPBQQ-o/export?format=csv&#gid=232544192',
  ];

  var gh_file_list  = [
                      'https://api.github.com/repos/TuftsCTSI/CVB/contents/MIMIC/Mappings/mimic_mapping.csv',
